...
public class Avro11Person extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private com.course.avro.data.Avro11Address address;
  private java.util.List<com.course.avro.data.Avro11BankAccount> bankAccounts;
   ...
   */
  public Avro11Person(java.lang.String firstName, java.lang.String lastName, java.time.LocalDate birthDate, com.course.avro.data.Avro11Address address, java.util.List<com.course.avro.data.Avro11BankAccount> bankAccounts) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: address = (com.course.avro.data.Avro11Address)value$; break;
    case 4: bankAccounts = (java.util.List<com.course.avro.data.Avro11BankAccount>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.course.avro.data.Avro11Address getAddress() {
    return address;
  }
   ...
   * @param value the value to set.
   */
  public void setAddress(com.course.avro.data.Avro11Address value) {
    this.address = value;
  }
   ...
   */
  public java.util.List<com.course.avro.data.Avro11BankAccount> getBankAccounts() {
    return bankAccounts;
  }
   ...
   * @param value the value to set.
   */
  public void setBankAccounts(java.util.List<com.course.avro.data.Avro11BankAccount> value) {
   ...
   */
  public static com.course.avro.data.Avro11Person.Builder newBuilder() {
    return new com.course.avro.data.Avro11Person.Builder();
  }
   ...
   * @return A new Avro11Person RecordBuilder
   */
  public static com.course.avro.data.Avro11Person.Builder newBuilder(com.course.avro.data.Avro11Person.Builder other) {
    if (other == null) {
      return new com.course.avro.data.Avro11Person.Builder();
    } else {
      return new com.course.avro.data.Avro11Person.Builder(other);
    }
  }
   ...
   * @return A new Avro11Person RecordBuilder
   */
  public static com.course.avro.data.Avro11Person.Builder newBuilder(com.course.avro.data.Avro11Person other) {
    if (other == null) {
      return new com.course.avro.data.Avro11Person.Builder();
    } else {
      return new com.course.avro.data.Avro11Person.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Avro11Person>
    ...
    private java.time.LocalDate birthDate;
    private com.course.avro.data.Avro11Address address;
    private com.course.avro.data.Avro11Address.Builder addressBuilder;
    private java.util.List<com.course.avro.data.Avro11BankAccount> bankAccounts;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.course.avro.data.Avro11Person.Builder other) {
      super(other);
      ...
      if (other.hasAddressBuilder()) {
        this.addressBuilder = com.course.avro.data.Avro11Address.newBuilder(other.getAddressBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.course.avro.data.Avro11Person other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Person.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Person.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Person.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Person.Builder clearLastName() {
      lastName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Person.Builder setBirthDate(java.time.LocalDate value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Person.Builder clearBirthDate() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Person.Builder setAddress(com.course.avro.data.Avro11Address value) {
     ...
     * @return This builder.
     */
    public com.course.avro.data.Avro11Address.Builder getAddressBuilder() {
      if (addressBuilder == null) {
        if (hasAddress()) {
          setAddressBuilder(com.course.avro.data.Avro11Address.newBuilder(address));
        } else {
          setAddressBuilder(com.course.avro.data.Avro11Address.newBuilder());
        }
      }
    ...
    public com.course.avro.data.Avro11Person.Builder setAddressBuilder(com.course.avro.data.Avro11Address.Builder value) {
      clearAddress();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Person.Builder clearAddress() {
      address = null;
      addressBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Person.Builder setBankAccounts(java.util.List<com.course.avro.data.Avro11BankAccount> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Person.Builder clearBankAccounts() {
      bankAccounts = null;
    ...
    public Avro11Person build() {
      try {
        ...
        if (addressBuilder != null) {
          ...
          record.address = fieldSetFlags()[3] ? this.address : (com.course.avro.data.Avro11Address) defaultValue(fields()[3]);
        }
        record.bankAccounts = fieldSetFlags()[4] ? this.bankAccounts : (java.util.List<com.course.avro.data.Avro11BankAccount>) defaultValue(fields()[4]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
