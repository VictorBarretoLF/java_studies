...
public class EmployeeForwardV2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EmployeeForwardV2\",\"namespace\":\"com.course.avro.data\",\"fields\":[{\"name\":\"firstName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"email\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public EmployeeForwardV2(java.lang.String firstName, java.lang.String lastName, java.lang.String email) {
   ...
   */
  public static com.course.avro.data.EmployeeForwardV2.Builder newBuilder() {
    return new com.course.avro.data.EmployeeForwardV2.Builder();
  }
   ...
   * @return A new EmployeeForwardV2 RecordBuilder
   */
  public static com.course.avro.data.EmployeeForwardV2.Builder newBuilder(com.course.avro.data.EmployeeForwardV2.Builder other) {
    if (other == null) {
      return new com.course.avro.data.EmployeeForwardV2.Builder();
    } else {
      return new com.course.avro.data.EmployeeForwardV2.Builder(other);
    }
  }
   ...
   * @return A new EmployeeForwardV2 RecordBuilder
   */
  public static com.course.avro.data.EmployeeForwardV2.Builder newBuilder(com.course.avro.data.EmployeeForwardV2 other) {
    if (other == null) {
      return new com.course.avro.data.EmployeeForwardV2.Builder();
    } else {
      return new com.course.avro.data.EmployeeForwardV2.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EmployeeForwardV2>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.course.avro.data.EmployeeForwardV2.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.course.avro.data.EmployeeForwardV2 other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.EmployeeForwardV2.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.EmployeeForwardV2.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.EmployeeForwardV2.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.EmployeeForwardV2.Builder clearLastName() {
      lastName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.EmployeeForwardV2.Builder setEmail(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.EmployeeForwardV2.Builder clearEmail() {
      email = null;
