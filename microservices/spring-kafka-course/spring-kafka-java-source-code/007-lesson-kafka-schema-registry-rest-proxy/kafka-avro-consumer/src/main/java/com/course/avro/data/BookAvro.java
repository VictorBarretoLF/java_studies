...
public class BookAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"BookAvro\",\"namespace\":\"com.course.avro.data\",\"fields\":[{\"name\":\"title\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"author\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"price\",\"type\":\"int\"}]}");
   ...
   */
  public static com.course.avro.data.BookAvro.Builder newBuilder() {
    return new com.course.avro.data.BookAvro.Builder();
  }
   ...
   * @return A new BookAvro RecordBuilder
   */
  public static com.course.avro.data.BookAvro.Builder newBuilder(com.course.avro.data.BookAvro.Builder other) {
    if (other == null) {
      return new com.course.avro.data.BookAvro.Builder();
    } else {
      return new com.course.avro.data.BookAvro.Builder(other);
    }
  }
   ...
   * @return A new BookAvro RecordBuilder
   */
  public static com.course.avro.data.BookAvro.Builder newBuilder(com.course.avro.data.BookAvro other) {
    if (other == null) {
      return new com.course.avro.data.BookAvro.Builder();
    } else {
      return new com.course.avro.data.BookAvro.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<BookAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.course.avro.data.BookAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.course.avro.data.BookAvro other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.title)) {
        this.title = data().deepCopy(fields()[0].schema(), other.title);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.BookAvro.Builder setTitle(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.BookAvro.Builder clearTitle() {
      title = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.BookAvro.Builder setAuthor(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.BookAvro.Builder clearAuthor() {
      author = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.BookAvro.Builder setPrice(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.BookAvro.Builder clearPrice() {
