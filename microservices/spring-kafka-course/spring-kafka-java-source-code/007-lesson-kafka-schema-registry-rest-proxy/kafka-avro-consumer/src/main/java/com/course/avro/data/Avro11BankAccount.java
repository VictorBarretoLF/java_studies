...
public class Avro11BankAccount extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.course.avro.data.Avro11BankAccount.Builder newBuilder() {
    return new com.course.avro.data.Avro11BankAccount.Builder();
  }
   ...
   * @return A new Avro11BankAccount RecordBuilder
   */
  public static com.course.avro.data.Avro11BankAccount.Builder newBuilder(com.course.avro.data.Avro11BankAccount.Builder other) {
    if (other == null) {
      return new com.course.avro.data.Avro11BankAccount.Builder();
    } else {
      return new com.course.avro.data.Avro11BankAccount.Builder(other);
    }
  }
   ...
   * @return A new Avro11BankAccount RecordBuilder
   */
  public static com.course.avro.data.Avro11BankAccount.Builder newBuilder(com.course.avro.data.Avro11BankAccount other) {
    if (other == null) {
      return new com.course.avro.data.Avro11BankAccount.Builder();
    } else {
      return new com.course.avro.data.Avro11BankAccount.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Avro11BankAccount>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.course.avro.data.Avro11BankAccount.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.course.avro.data.Avro11BankAccount other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.bankName)) {
        this.bankName = data().deepCopy(fields()[0].schema(), other.bankName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11BankAccount.Builder setBankName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11BankAccount.Builder clearBankName() {
      bankName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11BankAccount.Builder setAccountHolderName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11BankAccount.Builder clearAccountHolderName() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11BankAccount.Builder setAccountNumber(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11BankAccount.Builder clearAccountNumber() {
      accountNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11BankAccount.Builder setBankClearingCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11BankAccount.Builder clearBankClearingCode() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11BankAccount.Builder setCurrencyCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11BankAccount.Builder clearCurrencyCode() {
      currencyCode = null;
