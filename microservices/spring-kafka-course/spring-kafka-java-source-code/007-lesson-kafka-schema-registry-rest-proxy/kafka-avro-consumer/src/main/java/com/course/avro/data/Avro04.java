...
public class Avro04 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Avro04\",\"namespace\":\"com.course.avro.data\",\"doc\":\"Sample enum\",\"fields\":[{\"name\":\"allowedColor\",\"type\":{\"type\":\"enum\",\"name\":\"Avro04Enum\",\"doc\":\"Sample enum\",\"symbols\":[\"BLACK\",\"BLUE\",\"BROWN\"]}}]}");
  ...
  private com.course.avro.data.Avro04Enum allowedColor;
   ...
   */
  public Avro04(com.course.avro.data.Avro04Enum allowedColor) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: allowedColor = (com.course.avro.data.Avro04Enum)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.course.avro.data.Avro04Enum getAllowedColor() {
    return allowedColor;
  }
   ...
   */
  public void setAllowedColor(com.course.avro.data.Avro04Enum value) {
   ...
   */
  public static com.course.avro.data.Avro04.Builder newBuilder() {
    return new com.course.avro.data.Avro04.Builder();
  }
   ...
   * @return A new Avro04 RecordBuilder
   */
  public static com.course.avro.data.Avro04.Builder newBuilder(com.course.avro.data.Avro04.Builder other) {
    if (other == null) {
      return new com.course.avro.data.Avro04.Builder();
    } else {
      return new com.course.avro.data.Avro04.Builder(other);
    }
  }
   ...
   * @return A new Avro04 RecordBuilder
   */
  public static com.course.avro.data.Avro04.Builder newBuilder(com.course.avro.data.Avro04 other) {
    if (other == null) {
      return new com.course.avro.data.Avro04.Builder();
    } else {
      return new com.course.avro.data.Avro04.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Avro04>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.course.avro.data.Avro04.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.course.avro.data.Avro04 other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.allowedColor)) {
        this.allowedColor = data().deepCopy(fields()[0].schema(), other.allowedColor);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro04.Builder setAllowedColor(com.course.avro.data.Avro04Enum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro04.Builder clearAllowedColor() {
      allowedColor = null;
    ...
    public Avro04 build() {
      try {
        ...
        record.allowedColor = fieldSetFlags()[0] ? this.allowedColor : (com.course.avro.data.Avro04Enum) defaultValue(fields()[0]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      this.allowedColor = com.course.avro.data.Avro04Enum.values()[in.readEnum()];
