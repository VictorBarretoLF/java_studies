...
public class EmployeeBackward extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7328168082446555175L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EmployeeBackward\",\"namespace\":\"com.course.avro.data\",\"fields\":[{\"name\":\"firstName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"maritalStatus\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"UNKNOWN\"}]}");
   ...
   */
  public EmployeeBackward(java.lang.String firstName, java.lang.String lastName, java.lang.String maritalStatus) {
   ...
   */
  public static com.course.avro.data.EmployeeBackward.Builder newBuilder() {
    return new com.course.avro.data.EmployeeBackward.Builder();
  }
   ...
   * @return A new EmployeeBackward RecordBuilder
   */
  public static com.course.avro.data.EmployeeBackward.Builder newBuilder(com.course.avro.data.EmployeeBackward.Builder other) {
    if (other == null) {
      return new com.course.avro.data.EmployeeBackward.Builder();
    } else {
      return new com.course.avro.data.EmployeeBackward.Builder(other);
    }
  }
   ...
   * @return A new EmployeeBackward RecordBuilder
   */
  public static com.course.avro.data.EmployeeBackward.Builder newBuilder(com.course.avro.data.EmployeeBackward other) {
    if (other == null) {
      return new com.course.avro.data.EmployeeBackward.Builder();
    } else {
      return new com.course.avro.data.EmployeeBackward.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EmployeeBackward>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.course.avro.data.EmployeeBackward.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.course.avro.data.EmployeeBackward other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.EmployeeBackward.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.EmployeeBackward.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.EmployeeBackward.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.EmployeeBackward.Builder clearLastName() {
      lastName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.EmployeeBackward.Builder setMaritalStatus(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.EmployeeBackward.Builder clearMaritalStatus() {
      maritalStatus = null;
    ...
    public EmployeeBackward build() {
      try {
        ...
        record.maritalStatus = fieldSetFlags()[2] ? this.maritalStatus : (java.lang.String) defaultValue(fields()[2]);
        return record;
