...
public class Avro03 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private java.lang.String myMandatoryValue;
  private java.lang.String myOptionalValue;
  private java.lang.String myOptionalValueWithDefault;
   ...
   */
  public Avro03(java.lang.String myMandatoryValue, java.lang.String myOptionalValue, java.lang.String myOptionalValueWithDefault, java.lang.Object myWeirdButPossibleValue) {
   ...
   */
  public java.lang.String getMyMandatoryValue() {
   ...
   */
  public void setMyMandatoryValue(java.lang.String value) {
   ...
   */
  public java.lang.String getMyOptionalValue() {
   ...
   * @param value the value to set.
   */
  public void setMyOptionalValue(java.lang.String value) {
   ...
   */
  public java.lang.String getMyOptionalValueWithDefault() {
   ...
   * @param value the value to set.
   */
  public void setMyOptionalValueWithDefault(java.lang.String value) {
   ...
   */
  public static com.course.avro.data.Avro03.Builder newBuilder() {
    return new com.course.avro.data.Avro03.Builder();
  }
   ...
   * @return A new Avro03 RecordBuilder
   */
  public static com.course.avro.data.Avro03.Builder newBuilder(com.course.avro.data.Avro03.Builder other) {
    if (other == null) {
      return new com.course.avro.data.Avro03.Builder();
    } else {
      return new com.course.avro.data.Avro03.Builder(other);
    }
  }
   ...
   * @return A new Avro03 RecordBuilder
   */
  public static com.course.avro.data.Avro03.Builder newBuilder(com.course.avro.data.Avro03 other) {
    if (other == null) {
      return new com.course.avro.data.Avro03.Builder();
    } else {
      return new com.course.avro.data.Avro03.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Avro03>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.course.avro.data.Avro03.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.course.avro.data.Avro03 other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.myMandatoryValue)) {
        this.myMandatoryValue = data().deepCopy(fields()[0].schema(), other.myMandatoryValue);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro03.Builder setMyMandatoryValue(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro03.Builder clearMyMandatoryValue() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro03.Builder setMyOptionalValue(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro03.Builder clearMyOptionalValue() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro03.Builder setMyOptionalValueWithDefault(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro03.Builder clearMyOptionalValueWithDefault() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro03.Builder setMyWeirdButPossibleValue(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro03.Builder clearMyWeirdButPossibleValue() {
    ...
    public Avro03 build() {
      try {
        ...
        record.myMandatoryValue = fieldSetFlags()[0] ? this.myMandatoryValue : (java.lang.String) defaultValue(fields()[0]);
        record.myOptionalValue = fieldSetFlags()[1] ? this.myOptionalValue : (java.lang.String) defaultValue(fields()[1]);
        record.myOptionalValueWithDefault = fieldSetFlags()[2] ? this.myOptionalValueWithDefault : (java.lang.String) defaultValue(fields()[2]);
