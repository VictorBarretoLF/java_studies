...
public class Avro11Country extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Avro11Country\",\"namespace\":\"com.course.avro.data\",\"fields\":[{\"name\":\"code\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"ISO 3166-1 alpha-2 country code\"},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"country name\"}]}");
   ...
   */
  public static com.course.avro.data.Avro11Country.Builder newBuilder() {
    return new com.course.avro.data.Avro11Country.Builder();
  }
   ...
   * @return A new Avro11Country RecordBuilder
   */
  public static com.course.avro.data.Avro11Country.Builder newBuilder(com.course.avro.data.Avro11Country.Builder other) {
    if (other == null) {
      return new com.course.avro.data.Avro11Country.Builder();
    } else {
      return new com.course.avro.data.Avro11Country.Builder(other);
    }
  }
   ...
   * @return A new Avro11Country RecordBuilder
   */
  public static com.course.avro.data.Avro11Country.Builder newBuilder(com.course.avro.data.Avro11Country other) {
    if (other == null) {
      return new com.course.avro.data.Avro11Country.Builder();
    } else {
      return new com.course.avro.data.Avro11Country.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Avro11Country>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.course.avro.data.Avro11Country.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.course.avro.data.Avro11Country other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.code)) {
        this.code = data().deepCopy(fields()[0].schema(), other.code);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Country.Builder setCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Country.Builder clearCode() {
      code = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Country.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Country.Builder clearName() {
      name = null;
