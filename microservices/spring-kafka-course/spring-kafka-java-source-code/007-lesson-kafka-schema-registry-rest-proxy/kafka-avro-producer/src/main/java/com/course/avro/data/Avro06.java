...
public class Avro06 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** optional array */
  private java.util.List<java.lang.String> quotes;
   ...
   */
  public Avro06(java.util.List<java.lang.String> emails, java.util.List<java.lang.Integer> numbers, java.util.List<java.lang.String> quotes) {
    this.emails = emails;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: emails = (java.util.List<java.lang.String>)value$; break;
    case 1: numbers = (java.util.List<java.lang.Integer>)value$; break;
    case 2: quotes = (java.util.List<java.lang.String>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.List<java.lang.String> getQuotes() {
    return quotes;
  }
   ...
   * @param value the value to set.
   */
  public void setQuotes(java.util.List<java.lang.String> value) {
    this.quotes = value;
  }
   ...
   */
  public static com.course.avro.data.Avro06.Builder newBuilder() {
    return new com.course.avro.data.Avro06.Builder();
  }
   ...
   * @return A new Avro06 RecordBuilder
   */
  public static com.course.avro.data.Avro06.Builder newBuilder(com.course.avro.data.Avro06.Builder other) {
    if (other == null) {
      return new com.course.avro.data.Avro06.Builder();
    } else {
      return new com.course.avro.data.Avro06.Builder(other);
    }
  }
   ...
   * @return A new Avro06 RecordBuilder
   */
  public static com.course.avro.data.Avro06.Builder newBuilder(com.course.avro.data.Avro06 other) {
    if (other == null) {
      return new com.course.avro.data.Avro06.Builder();
    } else {
      return new com.course.avro.data.Avro06.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Avro06>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.course.avro.data.Avro06.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.course.avro.data.Avro06 other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.emails)) {
        this.emails = data().deepCopy(fields()[0].schema(), other.emails);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro06.Builder setEmails(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro06.Builder clearEmails() {
      emails = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro06.Builder setNumbers(java.util.List<java.lang.Integer> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro06.Builder clearNumbers() {
      numbers = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro06.Builder setQuotes(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro06.Builder clearQuotes() {
      quotes = null;
    ...
    public Avro06 build() {
      try {
        ...
        record.emails = fieldSetFlags()[0] ? this.emails : (java.util.List<java.lang.String>) defaultValue(fields()[0]);
        record.numbers = fieldSetFlags()[1] ? this.numbers : (java.util.List<java.lang.Integer>) defaultValue(fields()[1]);
        record.quotes = fieldSetFlags()[2] ? this.quotes : (java.util.List<java.lang.String>) defaultValue(fields()[2]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (this.quotes == null) {
      ...
      long actualSize2 = 0;
      for (java.lang.String e2: this.quotes) {
        actualSize2++;
        out.startItem();
        out.writeString(e2);
      }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        java.util.List<java.lang.String> a2 = this.quotes;
        if (a2 == null) {
          a2 = new SpecificData.Array<java.lang.String>((int)size2, SCHEMA$.getField("quotes").schema().getTypes().get(1));
          this.quotes = a2;
        } else a2.clear();
