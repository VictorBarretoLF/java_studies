...
public class Avro11Address extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private com.course.avro.data.Avro11Country country;
   ...
   */
  public Avro11Address(java.lang.String addressLine1, java.lang.String addressLine2, java.lang.String city, java.lang.String zipCode, com.course.avro.data.Avro11Country country) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: country = (com.course.avro.data.Avro11Country)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.course.avro.data.Avro11Country getCountry() {
    return country;
  }
   ...
   * @param value the value to set.
   */
  public void setCountry(com.course.avro.data.Avro11Country value) {
    this.country = value;
  }
   ...
   */
  public static com.course.avro.data.Avro11Address.Builder newBuilder() {
    return new com.course.avro.data.Avro11Address.Builder();
  }
   ...
   * @return A new Avro11Address RecordBuilder
   */
  public static com.course.avro.data.Avro11Address.Builder newBuilder(com.course.avro.data.Avro11Address.Builder other) {
    if (other == null) {
      return new com.course.avro.data.Avro11Address.Builder();
    } else {
      return new com.course.avro.data.Avro11Address.Builder(other);
    }
  }
   ...
   * @return A new Avro11Address RecordBuilder
   */
  public static com.course.avro.data.Avro11Address.Builder newBuilder(com.course.avro.data.Avro11Address other) {
    if (other == null) {
      return new com.course.avro.data.Avro11Address.Builder();
    } else {
      return new com.course.avro.data.Avro11Address.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Avro11Address>
    ...
    private java.lang.String zipCode;
    private com.course.avro.data.Avro11Country country;
    private com.course.avro.data.Avro11Country.Builder countryBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.course.avro.data.Avro11Address.Builder other) {
      super(other);
      ...
      if (other.hasCountryBuilder()) {
        this.countryBuilder = com.course.avro.data.Avro11Country.newBuilder(other.getCountryBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.course.avro.data.Avro11Address other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.addressLine1)) {
        this.addressLine1 = data().deepCopy(fields()[0].schema(), other.addressLine1);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Address.Builder setAddressLine1(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Address.Builder clearAddressLine1() {
      addressLine1 = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Address.Builder setAddressLine2(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Address.Builder clearAddressLine2() {
      addressLine2 = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Address.Builder setCity(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Address.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Address.Builder setZipCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Address.Builder clearZipCode() {
      zipCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Address.Builder setCountry(com.course.avro.data.Avro11Country value) {
     ...
     * @return This builder.
     */
    public com.course.avro.data.Avro11Country.Builder getCountryBuilder() {
      if (countryBuilder == null) {
        if (hasCountry()) {
          setCountryBuilder(com.course.avro.data.Avro11Country.newBuilder(country));
        } else {
          setCountryBuilder(com.course.avro.data.Avro11Country.newBuilder());
        }
      }
    ...
    public com.course.avro.data.Avro11Address.Builder setCountryBuilder(com.course.avro.data.Avro11Country.Builder value) {
      clearCountry();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro11Address.Builder clearCountry() {
      country = null;
      countryBuilder = null;
    ...
    public Avro11Address build() {
      try {
        ...
        if (countryBuilder != null) {
          ...
          record.country = fieldSetFlags()[4] ? this.country : (com.course.avro.data.Avro11Country) defaultValue(fields()[4]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.country == null) {
        this.country = new com.course.avro.data.Avro11Country();
      }
