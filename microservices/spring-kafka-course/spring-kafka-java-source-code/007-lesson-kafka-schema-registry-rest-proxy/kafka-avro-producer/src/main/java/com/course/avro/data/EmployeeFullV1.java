...
public class EmployeeFullV1 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EmployeeFullV1\",\"namespace\":\"com.course.avro.data\",\"fields\":[{\"name\":\"firstName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"-\"}]}");
   ...
   */
  public static com.course.avro.data.EmployeeFullV1.Builder newBuilder() {
    return new com.course.avro.data.EmployeeFullV1.Builder();
  }
   ...
   * @return A new EmployeeFullV1 RecordBuilder
   */
  public static com.course.avro.data.EmployeeFullV1.Builder newBuilder(com.course.avro.data.EmployeeFullV1.Builder other) {
    if (other == null) {
      return new com.course.avro.data.EmployeeFullV1.Builder();
    } else {
      return new com.course.avro.data.EmployeeFullV1.Builder(other);
    }
  }
   ...
   * @return A new EmployeeFullV1 RecordBuilder
   */
  public static com.course.avro.data.EmployeeFullV1.Builder newBuilder(com.course.avro.data.EmployeeFullV1 other) {
    if (other == null) {
      return new com.course.avro.data.EmployeeFullV1.Builder();
    } else {
      return new com.course.avro.data.EmployeeFullV1.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EmployeeFullV1>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.course.avro.data.EmployeeFullV1.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.course.avro.data.EmployeeFullV1 other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.EmployeeFullV1.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.EmployeeFullV1.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.EmployeeFullV1.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.EmployeeFullV1.Builder clearLastName() {
      lastName = null;
