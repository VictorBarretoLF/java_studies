...
public class Avro02 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.course.avro.data.Avro02.Builder newBuilder() {
    return new com.course.avro.data.Avro02.Builder();
  }
   ...
   * @return A new Avro02 RecordBuilder
   */
  public static com.course.avro.data.Avro02.Builder newBuilder(com.course.avro.data.Avro02.Builder other) {
    if (other == null) {
      return new com.course.avro.data.Avro02.Builder();
    } else {
      return new com.course.avro.data.Avro02.Builder(other);
    }
  }
   ...
   * @return A new Avro02 RecordBuilder
   */
  public static com.course.avro.data.Avro02.Builder newBuilder(com.course.avro.data.Avro02 other) {
    if (other == null) {
      return new com.course.avro.data.Avro02.Builder();
    } else {
      return new com.course.avro.data.Avro02.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Avro02>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.course.avro.data.Avro02.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.course.avro.data.Avro02 other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.myDecimal)) {
        this.myDecimal = data().deepCopy(fields()[0].schema(), other.myDecimal);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro02.Builder setMyDecimal(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro02.Builder clearMyDecimal() {
      myDecimal = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro02.Builder setMyUUID(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro02.Builder clearMyUUID() {
      myUUID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro02.Builder setMyDate(java.time.LocalDate value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro02.Builder clearMyDate() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro02.Builder setMyTimeMillis(java.time.LocalTime value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro02.Builder clearMyTimeMillis() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro02.Builder setMyTimestampMillis(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Avro02.Builder clearMyTimestampMillis() {
