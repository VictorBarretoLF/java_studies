...
public class Hello extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Hello\",\"namespace\":\"com.course.avro.data\",\"doc\":\"Hello world avro\",\"fields\":[{\"name\":\"myStringField\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Just a string\"},{\"name\":\"myIntField\",\"type\":\"int\",\"doc\":\"Just an int\"}]}");
   ...
   */
  public Hello(java.lang.String myStringField, java.lang.Integer myIntField) {
   ...
   */
  public void setMyStringField(java.lang.String value) {
   ...
   */
  public static com.course.avro.data.Hello.Builder newBuilder() {
    return new com.course.avro.data.Hello.Builder();
  }
   ...
   * @return A new Hello RecordBuilder
   */
  public static com.course.avro.data.Hello.Builder newBuilder(com.course.avro.data.Hello.Builder other) {
    if (other == null) {
      return new com.course.avro.data.Hello.Builder();
    } else {
      return new com.course.avro.data.Hello.Builder(other);
    }
  }
   ...
   * @return A new Hello RecordBuilder
   */
  public static com.course.avro.data.Hello.Builder newBuilder(com.course.avro.data.Hello other) {
    if (other == null) {
      return new com.course.avro.data.Hello.Builder();
    } else {
      return new com.course.avro.data.Hello.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Hello>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.course.avro.data.Hello.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.course.avro.data.Hello other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.myStringField)) {
        this.myStringField = data().deepCopy(fields()[0].schema(), other.myStringField);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Hello.Builder setMyStringField(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Hello.Builder clearMyStringField() {
      myStringField = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Hello.Builder setMyIntField(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Hello.Builder clearMyIntField() {
    ...
    public Hello build() {
      try {
        ...
        record.myStringField = fieldSetFlags()[0] ? this.myStringField : (java.lang.String) defaultValue(fields()[0]);
