...
public class Branch extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.course.avro.data.Branch.Builder newBuilder() {
    return new com.course.avro.data.Branch.Builder();
  }
   ...
   * @return A new Branch RecordBuilder
   */
  public static com.course.avro.data.Branch.Builder newBuilder(com.course.avro.data.Branch.Builder other) {
    if (other == null) {
      return new com.course.avro.data.Branch.Builder();
    } else {
      return new com.course.avro.data.Branch.Builder(other);
    }
  }
   ...
   * @return A new Branch RecordBuilder
   */
  public static com.course.avro.data.Branch.Builder newBuilder(com.course.avro.data.Branch other) {
    if (other == null) {
      return new com.course.avro.data.Branch.Builder();
    } else {
      return new com.course.avro.data.Branch.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Branch>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.course.avro.data.Branch.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.course.avro.data.Branch other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.address)) {
        this.address = data().deepCopy(fields()[0].schema(), other.address);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Branch.Builder setAddress(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Branch.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Branch.Builder setBranchId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Branch.Builder clearBranchId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Branch.Builder setCity(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Branch.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Branch.Builder setCountry(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.course.avro.data.Branch.Builder clearCountry() {
      country = null;
