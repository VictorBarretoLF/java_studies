...
public class MarketingCdcConsumer {
    ...
    public void listenPromotion(String message) throws JsonMappingException, JsonProcessingException {
        var promotion = objectMapper.readValue(message,
                new TypeReference<CdcMessage<MarketingPromotionMessage>>() {
                });
    ...
    public void listenSales(String message) throws JsonMappingException, JsonProcessingException {
        var sales = objectMapper.readValue(message,
                new TypeReference<CdcMessage<MarketingSalesMessage>>() {
                });
