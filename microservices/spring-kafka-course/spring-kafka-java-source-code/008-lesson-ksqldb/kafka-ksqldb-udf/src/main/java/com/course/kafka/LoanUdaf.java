...
@UdafDescription(name = "loan_rating", category = "LOAN", author = "Spring & Kafka Bootcamp by @timpamungkas", version = "5.0.0", description = "User defined function for sample tabular loan business logic.")
public class LoanUdaf {
    ...
    public static final Schema AGGREGATE_SCHEMA = SchemaBuilder.struct().optional()
            .field("goodPayment", Schema.OPTIONAL_INT32_SCHEMA).field("badPayment",
