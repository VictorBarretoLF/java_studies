...
@UdfDescription(name = "loan_installment", category = "LOAN", author = "Spring & Kafka Bootcamp by @timpamungkas", version = "5.0.0", description = "User defined function for sample scalar loan business logic.")
