...
@UdtfDescription(name = "loan_installment_schedule", category = "LOAN", author = "Spring & Kafka Bootcamp by @timpamungkas", version = "5.0.0", description = "User defined function for sample tabular loan business logic.")
